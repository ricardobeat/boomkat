...
| [host-functions.md](host-functions.md) | ✅ DONE | `jse_register_fn` + full host ABI (argc/arg/this/return/throw) in `src/capi.c3`; JS→host and host→JS both work; pinned by `test/capi/host_fn_abi.c` |
...
| [register-locals.md](register-locals.md) | ✅ DONE | Register-resident locals optimization; validated by the ENV_STRICT oracle (`boomkat_envstrict` target + corpus). Known gap: captured-local coherence — see plan 045 |
